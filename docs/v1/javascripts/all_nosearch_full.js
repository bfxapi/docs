    ...
    if ("ontouchstart" in window) {
        ...
        r = function(t) {
            if (!this.threshold && !e(this.startXY, [t.changedTouches[0].clientX, t.changedTouches[0].clientY])) {
                ...
                r.initMouseEvent("click", !0, !0, window, 0, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null),
                r.simulated = !0,
        ...
        i = function(e) {
            ...
            s.x = r,
            s.y = i,
            !((!e.simulated && (n < 500 || n < 1500 && a[0] < 50 && a[1] < 50) || f) && (e.preventDefault(), e.stopPropagation(), !f)) && (f && (window.location = u.getAttribute("href")), void(u && u.classList && (u.classList.add("energize-focus"), window.setTimeout(function() {
...
function(e, t) {
    ...
    function o(e, t, n) {
        return ge.isFunction(t) ? ge.grep(e,
        function(e, r) {
        ...
        }) : ke.test(t) ? ge.filter(t, e, n) : (t = ge.filter(t, e), ge.grep(e,
        function(e) {
    ...
    function v(e) {
        ...
        r = e.nodeName,
        i = Ue[r];
        return i ? i: (t = n.body.appendChild(n.createElement(r)), i = ge.css(t, "display"), t.parentNode.removeChild(t), "none" === i && (i = "block"), Ue[r] = i, i)
    }
    function m(e, t) {
        for (var n, r, i = [], o = 0, s = e.length; o < s; o++) r = e[o],
        r.style && (n = r.style.display, t ? ("none" === n && (i[o] = Pe.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && _e(r) && (i[o] = v(r))) : "none" !== n && (i[o] = "none", Pe.set(r, "display", n)));
    ...
    function x(e, t) {
        for (var n = 0,
        r = e.length; n < r; n++) Pe.set(e[n], "globalEval", !t || Pe.get(t[n], "globalEval"))
    }
    function b(e, t, n, r, i) {
        for (var o, s, a, u, c, l, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) if (o = e[p], o || 0 === o) if ("object" === ge.type(o)) ge.merge(d, o.nodeType ? [o] : o);
        else if (Ge.test(o)) {
            for (s = s || f.appendChild(t.createElement("div")), a = (Ve.exec(o) || ["", ""])[1].toLowerCase(), u = Qe[a] || Qe._default, s.innerHTML = u[1] + ge.htmlPrefilter(o) + u[2], l = u[0]; l--;) s = s.lastChild;
            ge.merge(d, s.childNodes),
            s = f.firstChild,
            s.textContent = ""
        } else d.push(t.createTextNode(o));
        for (f.textContent = "", p = 0; o = d[p++];) if (r && ge.inArray(o, r) > -1) i && i.push(o);
        else if (c = ge.contains(o.ownerDocument, o), s = y(f.appendChild(o), "script"), c && x(s), n) for (l = 0; o = s[l++];) Ye.test(o.type || "") && n.push(o);
        return f
    }
    function w() {
        return ! 0
    ...
    function S(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Re.hasData(e) && (a = Re.access(e), u = ge.extend({},
            a), Re.set(t, u))
        }
    }
    function L(e, t) {
    ...
    function D(e, t, r, i) {
        ...
        if (d && (o = b(t, e[0].ownerDocument, !1, e, i), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            for (a = ge.map(y(o, "script"), j), u = a.length; f < d; f++) c = o,
            f !== p && (c = ge.clone(c, !0, !0), u && ge.merge(a, y(c, "script"))),
            r.call(e[f], c, f);
            if (u) for (l = a[a.length - 1].ownerDocument, ge.map(a, A), f = 0; f < u; f++) c = a[f],
            Ye.test(c.type || "") && !Pe.access(c, "globalEval") && ge.contains(l, c) && (c.src ? ge._evalUrl && ge._evalUrl(c.src) : n(c.textContent.replace(ot, ""), l))
        }
        return e
    }
    function N(e, t, n) {
        for (var r, i = t ? ge.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || ge.cleanData(y(r)),
        r.parentNode && (n && ge.contains(r.ownerDocument, r) && x(y(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    function q(e, t, n) {
        var r, i, o, s, a = e.style;
        return n = n || ut(e),
        n && (s = n.getPropertyValue(t) || n[t], "" !== s || ge.contains(e.ownerDocument, e) || (s = ge.style(e, t)), !pe.pixelMarginRight() && at.test(s) && st.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)),
        void 0 !== s ? s + "": s
    }
    function O(e, t) {
        return {
    ...
    function F(e) {
        var t = ge.cssProps[e];
        return t || (t = ge.cssProps[e] = H(e) || e),
        t
    }
    function P(e, t, n) {
        var r = We.exec(t);
    ...
    function R(e, t, n, r, i) {
        var o, s = 0;
        for (o = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2)"margin" === n && (s += ge.css(e, n + Be[o], !0, i)),
        r ? ("content" === n && (s -= ge.css(e, "padding" + Be[o], !0, i)), "margin" !== n && (s -= ge.css(e, "border" + Be[o] + "Width", !0, i))) : (s += ge.css(e, "padding" + Be[o], !0, i), "padding" !== n && (s += ge.css(e, "border" + Be[o] + "Width", !0, i)));
        return s
    }
    function $(e, t, n) {
        var r, i = ut(e),
        ...
        return at.test(o) ? o: (r = s && (pe.boxSizingReliable() || o === e.style[t]), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), o = parseFloat(o) || 0, o + R(e, t, n || (s ? "border": "content"), r, i) + "px")
    }
    ...
    function z(e, t, n) {
        ...
        u = function() {
            ...
            o < 1 && u ? n: (u || a.notifyWith(e, [c, 1, 0]), a.resolveWith(e, [c]), !1)
        },
        c = a.promise({
            elem: e,
            props: ge.extend({},
        ...
        l = c.props;
        for (U(l, c.opts.specialEasing); o < s; o++) if (r = z.prefilters[o].call(c, e, l, c.opts)) return ge.isFunction(r.stop) && (ge._queueHooks(c.elem, c.opts.queue).stop = ge.proxy(r.stop, r)),
        r;
        return ge.map(l, _, c),
    ...
    function Q(e, t, n, r) {
        ...
        function(t, i) {
            n || St.test(e) ? r(e, i) : Q(e + "[" + ("object" == typeof i && null != i ? t: "") + "]", i, n, r)
        });
    ...
    ge.extend = ge.fn.extend = function() {
        ...
        a++), "object" == typeof s || ge.isFunction(s) || (s = {}), a === u && (s = this, a--); a < u; a++) if (null != (e = arguments[a])) for (t in e) n = s[t],
        r = e[t],
        s !== r && (c && r && (ge.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n: []) : o = n && ge.isPlainObject(n) ? n: {},
        s[t] = ge.extend(c, o, r)) : void 0 !== r && (s[t] = r));
        return s
    },
    ge.extend({
        ...
        map: function(e, t, n) {
            var i, o, s = 0,
            a = [];
            if (r(e)) for (i = e.length; s < i; s++) o = t(e[s], s, n),
            null != o && a.push(o);
        ...
        proxy: function(e, t) {
            var n, r, i;
            if ("string" == typeof t && (n = e[t], t = e, e = n), ge.isFunction(e)) return r = ie.call(arguments, 2),
            i = function() {
...
function(e) {
    function t(e, t, n, r) {
        ...
        if (!r && ((t ? t.ownerDocument || t: W) !== O && q(t), t = t || O, F)) {
            if (11 !== h && (u = me.exec(e))) if (i = u[1]) {
                if (9 === h) {
                    if (! (s = t.getElementById(i))) return n;
                    if (s.id === i) return n.push(s),
                    n
                } else if (d && (s = d.getElementById(i)) && I(t, s) && s.id === i) return n.push(s),
                n
            } else {
                if (u[2]) return K.apply(n, t.getElementsByTagName(e)),
                n;
                if ((i = u[3]) && T.getElementsByClassName && t.getElementsByClassName) return K.apply(n, t.getElementsByClassName(i)),
                n
            }
            if (T.qsa && !z[e + " "] && (!P || !P.test(e))) {
                ...
                l = e;
                    ...
                    for ((a = t.getAttribute("id")) ? a = a.replace(we, Te) : t.setAttribute("id", a = M), c = j(e), o = c.length; o--;) c[o] = "#" + a + " " + p(c[o]);
                    l = c.join(","),
                    d = ye.test(e) && f(t.parentNode) || t
                }
                if (l) try {
                    return K.apply(n, d.querySelectorAll(l)),
                    n
                } catch(e) {} finally {
    ...
    function h(e, t, n) {
        ...
        function(t, n, i) {
            ...
            } else for (; t = t[r];) if (1 === t.nodeType || s) if (f = t[M] || (t[M] = {}), l = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
            else {
    ...
    function x(e) {
        ...
        o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = h(function(e) {
            return e === t
        },
        s, !0), c = h(function(e) {
            return ee(t, e) > -1
        ...
        s, !0), l = [function(e, n, r) {
            var i = !o && (r || n !== L) || ((t = n).nodeType ? u(e, n, r) : c(e, n, r));
            return t = null,
            i
        }]; a < i; a++) if (n = C.relative[e[a].type]) l = [h(g(l), n)];
        else {
    ...
    function b(e, n) {
        ...
        s = function(r, s, a, u, c) {
            ...
            w = x.length;
            for (c && (L = s === O || s || c); h !== w && null != (l = x[h]); h++) {
                if (o && l) {
                    for (f = 0, s || l.ownerDocument === O || (q(l), a = !F); d = e[f++];) if (d(l, s || O, a)) {
                        u.push(l);
                        break
                    }
                    c && (B = b)
    ...
    var w, T, C, E, k, j, A, S, L, D, N, q, O, H, F, P, R, $, I, M = "sizzle" + 1 * new Date,
    W = e.document,
    B = 0,
    _ = 0,
    X = n(),
    ...
    q = t.setDocument = function(e) {
        ...
        return r !== O && 9 === r.nodeType && r.documentElement ? (O = r, H = O.documentElement, F = !k(O), W !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), T.attributes = i(function(e) {
            return e.className = "i",
            !e.getAttribute("className")
        }), T.getElementsByTagName = i(function(e) {
            return e.appendChild(O.createComment("")),
            !e.getElementsByTagName("*").length
        }), T.getElementsByClassName = ve.test(O.getElementsByClassName), T.getById = i(function(e) {
        ...
        R = [], P = [], (T.qsa = ve.test(O.querySelectorAll)) && (i(function(e) {
            ...
            P.push(",.*:")
        })), (T.matchesSelector = ve.test($ = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function(e) {
            T.disconnectedMatch = $.call(e, "*"),
            $.call(e, "[s!='']:x"),
            R.push("!=", oe)
        }), P = P.length && new RegExp(P.join("|")), R = R.length && new RegExp(R.join("|")), t = ve.test(H.compareDocumentPosition), I = t || ve.test(H.contains) ?
        function(e, t) {
        ...
        function(e, t) {
            ...
            return n ? n: (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === W && I(W, e) ? -1 : t === O || t.ownerDocument === W && I(W, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
        }: function(e, t) {
            if (e === t) return N = !0,
            0;
            var n, r = 0,
    ...
    t.matchesSelector = function(e, n) {
        if ((e.ownerDocument || e) !== O && q(e), n = n.replace(le, "='$1']"), T.matchesSelector && F && !z[n + " "] && (!R || !R.test(n)) && (!P || !P.test(n))) try {
            var r = $.call(e, n);
    ...
    C = t.selectors = {
        ...
        filter: {
            ...
            CLASS: function(e) {
                var t = X[e + " "];
                return t || (t = new RegExp("(^|" + ne + ")" + e + "(" + ne + "|$)")) && X(e,
                function(e) {
                ...
                function(e) {
                    ...
                    if (v) {
                        ...
                        if (h = [s ? v.firstChild: v.lastChild], s && y) {
                            for (d = v, f = d[M] || (d[M] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), c = l[e] || [], p = c[0] === B && c[1], x = p && c[2], d = p && v.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop();) if (1 === d.nodeType && ++x && d === t) {
                                l[e] = [B, p, x];
                                break
                            }
                        } else if (y && (d = t, f = d[M] || (d[M] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), c = l[e] || [], p = c[0] === B && c[1], x = p), x === !1) for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== m: 1 !== d.nodeType) || !++x || (y && (f = d[M] || (d[M] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), l[e] = [B, x]), d !== t)););
                        return x -= i,
                        x === r || x % r === 0 && x / r >= 0
                    }
                }
    ...
    j = t.tokenize = function(e, n) {
        ...
        for (a = e, u = [], c = C.preFilter; a;) {
            ...
            for (s in C.filter) ! (i = pe[s].exec(a)) || c[s] && !(i = c[s](i)) || (r = i.shift(), o.push({
                value: r,
                type: s,
                matches: i
            }), a = a.slice(r.length));
    ...
    A = t.compile = function(e, t) {
        ...
        o = z[e + " "];
        if (!o) {
            for (t || (t = j(e)), n = t.length; n--;) o = x(t[n]),
    ...
    S = t.select = function(e, t, n, r) {
        ...
        if (n = n || [], 1 === l.length) {
            if (o = l[0] = l[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && F && C.relative[o[1].type]) {
                if (t = (C.find.ID(s.matches[0].replace(xe, be), t) || [])[0], !t) return n;
                c && (t = t.parentNode),
                e = e.slice(o.shift().value.length)
            }
            for (i = pe.needsContext.test(e) ? 0 : o.length; i--&&(s = o[i], !C.relative[a = s.type]);) if ((u = C.find[a]) && (r = u(s.matches[0].replace(xe, be), ye.test(o[0].type) && f(t.parentNode) || t))) {
                if (o.splice(i, 1), e = r.length && p(o), !e) return K.apply(n, r),
                n;
                break
            }
        }
        return (c || A(e, l))(r, t, !F, n, !t || ye.test(e) && f(t.parentNode) || t),
        n
    },
...
ge.fn.extend({
    ...
    closest: function(e, t) {
        ...
        if (!Ce.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && ge.find.matchesSelector(n, e))) {
            o.push(n);
            break
        }
...
function(e, t) {
    ge.fn[e] = function(n, r) {
        ...
        this.length > 1 && (De[e] || ge.uniqueSort(i), Le.test(e) && i.reverse()),
        this.pushStack(i)
    }
});
var Ne = /[^\x20\t\r\n\f]+/g;
ge.Callbacks = function(e) {
    e = "string" == typeof e ? a(e) : ge.extend({},
    e);
    var t, n, r, i, o = [],
    s = [],
    u = -1,
    ...
    l = {
        add: function() {
            return o && (n && !t && (u = o.length - 1, s.push(n)),
            function t(n) {
                ge.each(n,
                function(n, r) {
                    ...
                    return function() {
                        ...
                        f = function() {
                            ...
                            if (! (t < s)) {
                                ...
                                ge.isFunction(f) ? i ? f.call(e, o(s, n, u, i), o(s, n, c, i)) : (s++, f.call(e, o(s, n, u, i), o(s, n, c, i), o(s, n, u, n.notifyWith))) : (r !== u && (a = void 0, l = [e]), (i || n.resolveWith)(a, l))
                            }
                        },
                        d = i ? f: function() {
                            try {
                                ...
                                t + 1 >= s && (r !== c && (a = void 0, l = [e]), n.rejectWith(a, l))
                            }
                        };
...
ge.extend({
    isReady: !1,
    readyWait: 1,
    ready: function(e) { (e === !0 ? --ge.readyWait: ge.isReady) || (ge.isReady = !0, e !== !0 && --ge.readyWait > 0 || Oe.resolveWith(ne, [ge]))
    }
}),
ge.ready.then = Oe.then,
"complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(ge.ready) : (ne.addEventListener("DOMContentLoaded", f), e.addEventListener("load", f));
var He = function(e, t, n, r, i, o, s) {
    var a = 0,
    u = e.length,
    c = null == n;
    if ("object" === ge.type(n)) {
...
d.prototype = {
    ...
    remove: function(e, t) {
        ...
        if (void 0 !== r) {
            if (void 0 !== t) {
                Array.isArray(t) ? t = t.map(ge.camelCase) : (t = ge.camelCase(t), t = t in r ? [t] : t.match(Ne) || []),
                n = t.length;
                for (; n--;) delete r[t[n]]
...
ge.fn.extend({
    ...
    promise: function(e, t) {
        ...
        for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) n = Pe.get(o[s], e + "queueHooks"),
...
ge.event = {
    ...
    add: function(e, t, n, r, i) {
        ...
        if (v) for (n.handler && (o = n, n = o.handler, i = o.selector), i && ge.find.matchesSelector(Je, i), n.guid || (n.guid = ge.guid++), (u = v.events) || (u = v.events = {}), 
...
p = (i ? f.delegateType: f.bindType) || p, f = ge.event.special[p] || {},
l = ge.extend({
    type: p,
    origType: g,
    data: r,
...
remove: function(e, t, n, r, i) {
    ...
    if (v && (u = v.events)) {
        for (t = (t || "").match(Ne) || [""], c = t.length; c--;) if (a = et.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
...
handlers: function(e, t) {
    ...
    if (u && c.nodeType && !("click" === e.type && e.button >= 1)) for (; c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== e.type || c.disabled !== !0)) {
        ...
        n = 0; n < u; n++) r = t[n],
        i = r.selector + " ",
        void 0 === s[i] && (s[i] = r.needsContext ? ge(i, this).index(c) > -1 : ge.find(i, this, null, [c]).length),
        s[i] && o.push(r);
        o.length && a.push({
            elem: c,
            handlers: o
...
function(e, t) {
    ge.event.special[e] = {
        ...
        handle: function(e) {
            ...
            i = e.relatedTarget,
            o = e.handleObj;
            return i && (i === r || ge.contains(r, i)) || (e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t),
            n
        }
    }
}), ge.fn.extend({
...
ot = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;ge.extend({
    ...
    clone: function(e, t, n) {
        ...
        if (! (pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ge.isXMLDoc(e))) for (s = y(a), o = y(e), r = 0, i = o.length; r < i; r++) L(o[r], s[r]);
        if (t) if (n) for (o = o || y(e), s = s || y(a), r = 0, i = o.length; r < i; r++) S(o[r], s[r]);
        else S(e, a);
        return s = y(a, "script"),
        s.length > 0 && x(s, !u && y(e, "script")),
        a
    },
    cleanData: function(e) {
        for (var t, n, r, i = ge.event.special,
        o = 0; void 0 !== (n = e[o]); o++) if (Fe(n)) {
            if (t = n[Pe.expando]) {
    ...
    html: function(e) {
        ...
        function(e) {
            ...
            if ("string" == typeof e && !nt.test(e) && !Qe[(Ve.exec(e) || ["", ""])[1].toLowerCase()]) {
...
function(e, t) {
    ge.fn[e] = function(e) {
        for (var n, r = [], i = ge(e), o = i.length - 1, s = 0; s <= o; s++) n = s === o ? this: this.clone(!0),
        ge(i[s])[t](n),
        se.apply(r, n.get());
...
var st = /^margin/,
at = new RegExp("^(" + Me + ")(?!px)[a-z%]+$", "i"), ut = function(t) {
...
pt = ["Webkit", "Moz", "ms"], ht = ne.createElement("div").style;ge.extend({
    cssHooks: {
        opacity: {
            get: function(e, t) {
                if (t) {
    ...
    style: function(e, t, n, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            ...
            void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i: c[t] : (o = typeof n, "string" === o && (i = We.exec(n)) && i[1] && (n = g(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (ge.cssNumber[a] ? "": "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u ? c.setProperty(t, n) : c[t] = n)), void 0)
        }
    },
...
function(e, t) {
    ge.cssHooks[t] = {
        get: function(e, n, r) {
            if (n) return ! ct.test(ge.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? $(e, t, r) : Xe(e, ft,
            function() {
                return $(e, t, r)
            })
        },
        set: function(e, n, r) {
            var i, o = r && ut(e),
            s = r && R(e, t, r, "border-box" === ge.css(e, "boxSizing", !1, o), o);
            return s && (i = We.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = ge.css(e, t)),
            P(e, n, s)
        }
    }
}), ge.cssHooks.marginLeft = O(pe.reliableMarginLeft,
function(e, t) {
...
yt = /queueHooks$/;ge.Animation = ge.extend(z, {
    tweeners: {
        "*": [function(e, t) {
            var n = this.createTween(e, t);
            return g(n.elem, e, We.exec(t), n),
            n
        }]
    },
...
ge.fn.extend({
    ...
    stop: function(e, t, n) {
        ...
        this.each(function() {
            ...
            for (i = o.length; i--;) o[i].elem !== this || null != e && o[i].queue !== e || (o[i].anim.stop(n), t = !1, o.splice(i, 1)); ! t && n || ge.dequeue(this, e)
        })
    },
    finish: function(e) {
        return e !== !1 && (e = e || "fx"),
...
var xt, bt = ge.expr.attrHandle;ge.fn.extend({
    attr: function(e, t) {
...
function(e, t) {
    ...
    bt[t] = function(e, t, r) {
        ...
        return r || (o = bt[s], bt[s] = i, i = null != n(e, t, r) ? s: null, bt[s] = o),
        i
    }
});
var wt = /^(?:input|select|textarea|button)$/i,
Tt = /^(?:a|area)$/i;ge.fn.extend({
    prop: function(e, t) {
    ...
    prop: function(e, t, n) {
        var r, i, o = e.nodeType;
        if (3 !== o && 8 !== o && 2 !== o) return 1 === o && ge.isXMLDoc(e) || (t = ge.propFix[t] || t, i = ge.propHooks[t]),
...
function() {
    ...
    addClass: function(e) {
        ...
        if ("string" == typeof e && e) for (t = e.match(Ne) || []; n = this[u++];) if (i = Y(n), r = 1 === n.nodeType && " " + V(i) + " ") {
    ...
    toggleClass: function(e, t) {
        ...
        return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ge.isFunction(e) ? this.each(function(n) {
            ...
            var t, r, i, o;
            if ("string" === n) for (r = 0, i = ge(this), o = e.match(Ne) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            else void 0 !== e && "boolean" !== n || (t = Y(this), t && Pe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "": Pe.get(this, "__className__") || ""))
        })
    },
    hasClass: function(e) {
        var t, n, r = 0;
        for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && (" " + V(Y(n)) + " ").indexOf(t) > -1) return ! 0;
        return ! 1
    }
});
var Ct = /\r/g;ge.fn.extend({
    val: function(e) {
        var t, n, r, i = this[0]; {
            if (arguments.length) return r = ge.isFunction(e),
            this.each(function(n) {
                var i;
                1 === this.nodeType && (i = r ? e.call(this, n, ge(this).val()) : e, null == i ? i = "": "number" == typeof i ? i += "": Array.isArray(i) && (i = ge.map(i,
                function(e) {
                    return null == e ? "": e + ""
                })), t = ge.valHooks[this.type] || ge.valHooks[this.nodeName.toLowerCase()], t && "set" in t && void 0 !== t.set(this, i, "value") || (this.value = i))
            });
            if (i) return t = ge.valHooks[i.type] || ge.valHooks[i.nodeName.toLowerCase()],
            t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n: (n = i.value, "string" == typeof n ? n.replace(Ct, "") : null == n ? "": n)
        }
    }
}), ge.extend({
    valHooks: {
        ...
        select: {
            ...
            set: function(e, t) {
                ...
                o = ge.makeArray(t), s = i.length; s--;) r = i[s],
...
var Et = /^(?:focusinfocus|focusoutblur)$/;ge.extend(ge.event, {
    trigger: function(t, n, r, i) {
        ...
        i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
            if (!i && !f.noBubble && !ge.isWindow(r)) {
                for (u = f.delegateType || p, Et.test(u + p) || (s = s.parentNode); s; s = s.parentNode) d.push(s),
                a = s;
                a === (r.ownerDocument || ne) && d.push(a.defaultView || a.parentWindow || e)
            }
            for (o = 0; (s = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u: f.bindType || p,
            l = (Pe.get(s, "events") || {})[t.type] && Pe.get(s, "handle"),
            l && l.apply(s, n),
            l = c && s[c],
            l && l.apply && Fe(s) && (t.result = l.apply(s, n), t.result === !1 && t.preventDefault());
            return t.type = p,
            i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Fe(r) || c && ge.isFunction(r[p]) && !ge.isWindow(r) && (a = r[c], a && (r[c] = null), ge.event.triggered = p, r[p](), ge.event.triggered = void 0, a && (r[c] = a)),
            t.result
        }
    },
...
}), ge.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),
function(e, t) {
...
var kt = e.location,
jt = ge.now(), At = /\?/;ge.parseXML = function(t) {
    var n;
...
Nt = /^(?:input|select|textarea|keygen)/i;ge.param = function(e, t) {
    var n, r = [],
    i = function(e, t) {
...
It = {},
Mt = {},
Wt = "*/".concat("*"), Bt = ne.createElement("a");Bt.href = kt.href, ge.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ajaxSettings: {
    ...
    ajax: function(t, n) {
        function r(t, n, r, a) {
            var c, d, p, b, w, T = n;
            l || (l = !0, u && e.clearTimeout(u), i = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, r && (b = Z(h, C, r)), b = ee(h, b, C, c), c ? (h.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (ge.lastModified[o] = w), w = C.getResponseHeader("etag"), w && (ge.etag[o] = w)), 204 === t || "HEAD" === h.type ? T = "nocontent": 304 === t ? T = "notmodified": (T = b.state, d = b.data, p = b.error, c = !p)) : (p = T, !t && T || (T = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || T) + "", c ? m.resolveWith(g, [d, T, C]) : m.rejectWith(g, [C, T, p]), C.statusCode(x), x = void 0, f && v.trigger(c ? "ajaxSuccess": "ajaxError", [C, h, c ? d: p]), y.fireWith(g, [C, T]), f && (v.trigger("ajaxComplete", [C, h]), --ge.active || ge.event.trigger("ajaxStop")))
        }
        "object" == typeof t && (n = t, t = void 0),
        n = n || {};
        var i, o, s, a, u, c, l, f, d, p, h = ge.ajaxSetup({},
        n),
        g = h.context || h,
        ...
        if (m.promise(C), h.url = ((t || h.url || kt.href) + "").replace($t, kt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ne) || [""], null == h.crossDomain) {
        ...
        if (h.data && h.processData && "string" != typeof h.data && (h.data = ge.param(h.data, h.traditional)), J(It, h, n, C), l) return C;
        f = ge.event && h.global,
        f && 0 === ge.active++&&ge.event.trigger("ajaxStart"),
        h.type = h.type.toUpperCase(),
        h.hasContent = !Rt.test(h.type),
        o = h.url.replace(Ot, ""),
        h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(qt, "+")) : (p = h.url.slice(o.length), h.data && (o += (At.test(o) ? "&": "?") + h.data, delete h.data), h.cache === !1 && (o = o.replace(Ht, "$1"), p = (At.test(o) ? "&": "?") + "_=" + jt+++p), h.url = o + p),
        h.ifModified && (ge.lastModified[o] && C.setRequestHeader("If-Modified-Since", ge.lastModified[o]), ge.etag[o] && C.setRequestHeader("If-None-Match", ge.etag[o])),
...
Xt = ge.ajaxSettings.xhr();pe.cors = !!Xt && "withCredentials" in Xt, pe.ajax = Xt = !!Xt, ge.ajaxTransport(function(t) {
    var n, r;
    if (pe.cors || Xt && !t.crossDomain) return {
        send: function(i, o) {
            var s, a = t.xhr();
            ...
            n = function(e) {
                return function() {
                    n && (n = r = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(_t[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                        binary: a.response
                    }: {
                        text: a.responseText
                    },
...
var Ut = [], zt = /(=)\?(?=&|$)|\?\?/;ge.ajaxSetup({
    jsonp: "callback",
    jsonpCallback: function() {
        var e = Ut.pop() || ge.expando + "_" + jt++;
        return this[e] = !0,
        e
    }
...
function(t, n, r) {
    ...
    if (a || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = ge.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
    a ? t[a] = t[a].replace(zt, "$1" + i) : t.jsonp !== !1 && (t.url += (At.test(t.url) ? "&": "?") + t.jsonp + "=" + i),
    ...
    var r, i, o;
    return t || (pe.createHTMLDocument ? (t = ne.implementation.createHTMLDocument(""), r = t.createElement("base"), r.href = ne.location.href, t.head.appendChild(r)) : t = ne),
    i = Ee.exec(e),
    o = !n && [],
    i ? [t.createElement(i[1])] : (i = b([e], t, o), o && o.length && ge(o).remove(), ge.merge([], i.childNodes))
},
ge.fn.load = function(e, t, n) {
    var r, i, o, s = this,
    a = e.indexOf(" ");
    return a > -1 && (r = V(e.slice(a)), e = e.slice(0, a)),
...
function(e, t) {
    ge.cssHooks[t] = O(pe.pixelPosition,
    function(e, n) {
        if (n) return n = q(e, t),
...
ge.isArray = Array.isArray, ge.parseJSON = JSON.parse, ge.nodeName = i, "function" == typeof define && define.amd && define("jquery", [],
function() {
    return ge
});
var Vt = e.jQuery,
...
function() {
    ...
    r.emitEvent = function(e, t) {
        ...
        for (i in s) if (s.hasOwnProperty(i)) for (r = s[i].length; r--;) n = s[i][r],
...
function(e, t, n) {
    ...
    s.prototype.check = function() {
        function e(e, i) {
            return t.options.debug && f && l.log("confirm", e, i),
            t.progress(e),
            n++,
            n === r && t.complete(),
            !0
    ...
    function e(e, i, o, s) {
        ...
        d = function() {
            ...
            if (!d.hasClass("active")) {
                ...
                d.addClass("active"),
                d.parents(o).addClass("active").siblings(i).addClass("active-parent"),
        ...
        p = function() {
            ...
            $("#nav-button").click(function() {
                return $(".toc-wrapper").toggleClass("open"),
...
function() {
    ...
    function e(e) {
        if (e && "" !== e) {
            ...
            for (var t = 0; t < a.length; t++) $(".highlight.tab-" + a[t]).hide(),
    ...
    function t(e) {
        return "string" != typeof e ? {}: (e = e.trim().replace(/^(\?|#|&)/, ""), e ? e.split("&").reduce(function(e, t) {
            ...
            e.hasOwnProperty(r) ? Array.isArray(e[r]) ? e[r].push(i) : e[r] = [e[r], i] : e[r] = i,
            e
        },
        {}) : {})
    }
